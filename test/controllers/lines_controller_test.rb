...
class LinesControllerTest < ActionController::TestCase
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post :create, line: { cantidad: @line.cantidad, car_id: @line.car_id, product_id: @line.product_id }
    end
  ...
  test "should update line" do
    patch :update, id: @line, line: { cantidad: @line.cantidad, car_id: @line.car_id, product_id: @line.product_id }
    assert_redirected_to line_path(assigns(:line))
  end
